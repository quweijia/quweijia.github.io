  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      updateHoverState(clientX, clientY) {
        this.isHoverInside = this.isPointInside(
          clientX,
          clientY,
        );
    ...
    class AutoDriver {
      ...
      update() {
        ...
        const dir = this._tmpDir.subVectors(
          this.target,
          this.current,
        );
...
`;
    ...
    class ExternalForce extends ShaderPass {
      ...
      update(props) {
        ...
        const cursorSizeX =
          props.cursor_size * props.cellScale.x;
        const cursorSizeY =
          props.cursor_size * props.cellScale.y;
    ...
    // Container is already positioned via className, don't override
