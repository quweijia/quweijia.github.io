 ...
 */var Fp;function Dx(){if(Fp)return gt;Fp=1;var s=Symbol.for("react.element"),e=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),a=Symbol.for("react.profiler"),l=Symbol.for("react.provider"),d=Symbol.for("react.context"),f=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),S=Symbol.for("react.lazy"),x=Symbol.iterator;function y(O){return O===null||typeof O!="object"?null:(O=x&&O[x]||O["@@iterator"],typeof O=="function"?O:null)}var M={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},b=Object.assign,w={};function _(O,re,Le){this.props=O,this.context=re,this.refs=w,this.updater=Le||M}_.prototype.isReactComponent={},_.prototype.setState=function(O,re){if(typeof O!="object"&&typeof O!="function"&&O!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,O,re,"setState")},_.prototype.forceUpdate=function(O){this.updater.enqueueForceUpdate(this,O,"forceUpdate")};function v(){}v.prototype=_.prototype;function D(O,re,Le){this.props=O,this.context=re,this.refs=w,this.updater=Le||M}var N=D.prototype=new v;N.constructor=D,b(N,_.prototype),N.isPureReactComponent=!0;var T=Array.isArray,V=Object.prototype.hasOwnProperty,z={current:null},I={key:!0,ref:!0,__self:!0,__source:!0};function U(O,re,Le){var ne,ge={},we=null,Se=null;if(re!=null)for(ne in re.ref!==void 0&&(Se=re.ref),re.key!==void 0&&(we=""+re.key),re)V.call(re,ne)&&!I.hasOwnProperty(ne)&&(ge[ne]=re[ne]);var Re=arguments.length-2;if(Re===1)ge.children=Le;else if(1<Re){for(var Fe=Array(Re),Ke=0;Ke<Re;Ke++)Fe[Ke]=arguments[Ke+2];ge.children=Fe}if(O&&O.defaultProps)for(ne in Re=O.defaultProps,Re)ge[ne]===void 0&&(ge[ne]=Re[ne]);return{$$typeof:s,type:O,key:we,ref:Se,props:ge,_owner:z.current}}function P(O,re){return{$$typeof:s,type:O.type,key:re,ref:O.ref,props:O.props,_owner:O._owner}}function C(O){return typeof O=="object"&&O!==null&&O.$$typeof===s}function B(O){var re={"=":"=0",":":"=2"};return"$"+O.replace(/[=:]/g,function(Le){return re[Le]})}var oe=/\/+/g;function J(O,re){return typeof O=="object"&&O!==null&&O.key!=null?B(""+O.key):re.toString(36)}function fe(O,re,Le,ne,ge){var we=typeof O;(we==="undefined"||we==="boolean")&&(O=null);var Se=!1;if(O===null)Se=!0;else switch(we){case"string":case"number":Se=!0;break;case"object":switch(O.$$typeof){case s:case e:Se=!0}}if(Se)return Se=O,ge=ge(Se),O=ne===""?"."+J(Se,0):ne,T(ge)?(Le="",O!=null&&(Le=O.replace(oe,"$&/")+"/"),fe(ge,re,Le,"",function(Ke){return Ke})):ge!=null&&(C(ge)&&(ge=P(ge,Le+(!ge.key||Se&&Se.key===ge.key?"":(""+ge.key).replace(oe,"$&/")+"/")+O)),re.push(ge)),1;if(Se=0,ne=ne===""?".":ne+":",T(O))for(var Re=0;Re<O.length;Re++){we=O[Re];var Fe=ne+J(we,Re);Se+=fe(we,re,Le,Fe,ge)}else if(Fe=y(O),typeof Fe=="function")for(O=Fe.call(O),Re=0;!(we=O.next()).done;)we=we.value,Fe=ne+J(we,Re++),Se+=fe(we,re,Le,Fe,ge);else if(we==="object")throw re=String(O),Error("Objects are not valid as a React child (found: "+(re==="[object Object]"?"object with keys {"+Object.keys(O).join(", ")+"}":re)+"). If you meant to render a collection of children, use an array instead.");return Se}function me(O,re,Le){if(O==null)return O;var ne=[],ge=0;return fe(O,ne,"","",function(we){return re.call(Le,we,ge++)}),ne}function ue(O){if(O._status===-1){var re=O._result;re=re(),re.then(function(Le){(O._status===0||O._status===-1)&&(O._status=1,O._result=Le)},function(Le){(O._status===0||O._status===-1)&&(O._status=2,O._result=Le)}),O._status===-1&&(O._status=0,O._result=re)}if(O._status===1)return O._result.default;throw O._result}var pe={current:null},j={transition:null},te={ReactCurrentDispatcher:pe,ReactCurrentBatchConfig:j,ReactCurrentOwner:z};function se(){throw Error("act(...) is not supported in production builds of React.")}return gt.Children={map:me,forEach:function(O,re,Le){me(O,function(){re.apply(this,arguments)},Le)},count:function(O){var re=0;return me(O,function(){re++}),re},toArray:function(O){return me(O,function(re){return re})||[]},only:function(O){if(!C(O))throw Error("React.Children.only expected to receive a single React element child.");return O}},gt.Component=_,gt.Fragment=t,gt.Profiler=a,gt.PureComponent=D,gt.StrictMode=r,gt.Suspense=p,gt.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=te,gt.act=se,gt.cloneElement=function(O,re,Le){if(O==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+O+".");var ne=b({},O.props),ge=O.key,we=O.ref,Se=O._owner;if(re!=null){if(re.ref!==void 0&&(we=re.ref,Se=z.current),re.key!==void 0&&(ge=""+re.key),O.type&&O.type.defaultProps)var Re=O.type.defaultProps;for(Fe in re)V.call(re,Fe)&&!I.hasOwnProperty(Fe)&&(ne[Fe]=re[Fe]===void 0&&Re!==void 0?Re[Fe]:re[Fe])}var Fe=arguments.length-2;if(Fe===1)ne.children=Le;else if(1<Fe){Re=Array(Fe);for(var Ke=0;Ke<Fe;Ke++)Re[Ke]=arguments[Ke+2];ne.children=Re}return{$$typeof:s,type:O.type,key:ge,ref:we,props:ne,_owner:Se}},gt.createContext=function(O){return O={$$typeof:d,_currentValue:O,_currentValue2:O,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},O.Provider={$$typeof:l,_context:O},O.Consumer=O},gt.createElement=U,gt.createFactory=function(O){var re=U.bind(null,O);return re.type=O,re},gt.createRef=function(){return{current:null}},gt.forwardRef=function(O){return{$$typeof:f,render:O}},gt.isValidElement=C,gt.lazy=function(O){return{$$typeof:S,_payload:{_status:-1,_result:O},_init:ue}},gt.memo=function(O,re){return{$$typeof:m,type:O,compare:re===void 0?null:re}},gt.startTransition=function(O){var re=j.transition;j.transition={};try{O()}finally{j.transition=re}},gt.unstable_act=se,gt.useCallback=function(O,re){return pe.current.useCallback(O,re)},gt.useContext=function(O){return pe.current.useContext(O)},gt.useDebugValue=function(){},gt.useDeferredValue=function(O){return pe.current.useDeferredValue(O)},gt.useEffect=function(O,re){return pe.current.useEffect(O,re)},gt.useId=function(){return pe.current.useId()},gt.useImperativeHandle=function(O,re,Le){return pe.current.useImperativeHandle(O,re,Le)},gt.useInsertionEffect=function(O,re){return pe.current.useInsertionEffect(O,re)},gt.useLayoutEffect=function(O,re){return pe.current.useLayoutEffect(O,re)},gt.useMemo=function(O,re){return pe.current.useMemo(O,re)},gt.useReducer=function(O,re,Le){return pe.current.useReducer(O,re,Le)},gt.useRef=function(O){return pe.current.useRef(O)},gt.useState=function(O){return pe.current.useState(O)},gt.useSyncExternalStore=function(O,re,Le){return pe.current.useSyncExternalStore(O,re,Le)},gt.useTransition=function(){return pe.current.useTransition()},gt.version="18.3.1",gt}var Op;function nf(){return Op||(Op=1,Tu.exports=Dx()),Tu.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var zp;function Lx(){if(zp)return Lo;zp=1;var s=nf(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),r=Object.prototype.hasOwnProperty,a=s.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,l={key:!0,ref:!0,__self:!0,__source:!0};function d(f,p,m){var S,x={},y=null,M=null;m!==void 0&&(y=""+m),p.key!==void 0&&(y=""+p.key),p.ref!==void 0&&(M=p.ref);for(S in p)r.call(p,S)&&!l.hasOwnProperty(S)&&(x[S]=p[S]);if(f&&f.defaultProps)for(S in p=f.defaultProps,p)x[S]===void 0&&(x[S]=p[S]);return{$$typeof:e,type:f,key:y,ref:M,props:x,_owner:a.current}}return Lo.Fragment=t,Lo.jsx=d,Lo.jsxs=d,Lo}var Bp;function kx(){return Bp||(Bp=1,Eu.exports=Lx()),Eu.exports}var u=kx(),rl={},Au={exports:{}},Cn={},Cu={exports:{}},Ru={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var jp;function Ix(){return jp||(jp=1,(function(s){function e(j,te){var se=j.length;j.push(te);e:for(;0<se;){var O=se-1>>>1,re=j[O];if(0<a(re,te))j[O]=te,j[se]=re,se=O;else break e}}function t(j){return j.length===0?null:j[0]}function r(j){if(j.length===0)return null;var te=j[0],se=j.pop();if(se!==te){j[0]=se;e:for(var O=0,re=j.length,Le=re>>>1;O<Le;){var ne=2*(O+1)-1,ge=j[ne],we=ne+1,Se=j[we];if(0>a(ge,se))we<re&&0>a(Se,ge)?(j[O]=Se,j[we]=se,O=we):(j[O]=ge,j[ne]=se,O=ne);else if(we<re&&0>a(Se,se))j[O]=Se,j[we]=se,O=we;else break e}}return te}function a(j,te){var se=j.sortIndex-te.sortIndex;return se!==0?se:j.id-te.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;s.unstable_now=function(){return l.now()}}else{var d=Date,f=d.now();s.unstable_now=function(){return d.now()-f}}var p=[],m=[],S=1,x=null,y=3,M=!1,b=!1,w=!1,_=typeof setTimeout=="function"?setTimeout:null,v=typeof clearTimeout=="function"?clearTimeout:null,D=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function N(j){for(var te=t(m);te!==null;){if(te.callback===null)r(m);else if(te.startTime<=j)r(m),te.sortIndex=te.expirationTime,e(p,te);else break;te=t(m)}}function T(j){if(w=!1,N(j),!b)if(t(p)!==null)b=!0,ue(V);else{var te=t(m);te!==null&&pe(T,te.startTime-j)}}function V(j,te){b=!1,w&&(w=!1,v(U),U=-1),M=!0;var se=y;try{for(N(te),x=t(p);x!==null&&(!(x.expirationTime>te)||j&&!B());){var O=x.callback;if(typeof O=="function"){x.callback=null,y=x.priorityLevel;var re=O(x.expirationTime<=te);te=s.unstable_now(),typeof re=="function"?x.callback=re:x===t(p)&&r(p),N(te)}else r(p);x=t(p)}if(x!==null)var Le=!0;else{var ne=t(m);ne!==null&&pe(T,ne.startTime-te),Le=!1}return Le}finally{x=null,y=se,M=!1}}var z=!1,I=null,U=-1,P=5,C=-1;function B(){return!(s.unstable_now()-C<P)}function oe(){if(I!==null){var j=s.unstable_now();C=j;var te=!0;try{te=I(!0,j)}finally{te?J():(z=!1,I=null)}}else z=!1}var J;if(typeof D=="function")J=function(){D(oe)};else if(typeof MessageChannel<"u"){var fe=new MessageChannel,me=fe.port2;fe.port1.onmessage=oe,J=function(){me.postMessage(null)}}else J=function(){_(oe,0)};function ue(j){I=j,z||(z=!0,J())}function pe(j,te){U=_(function(){j(s.unstable_now())},te)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(j){j.callback=null},s.unstable_continueExecution=function(){b||M||(b=!0,ue(V))},s.unstable_forceFrameRate=function(j){0>j||125<j?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):P=0<j?Math.floor(1e3/j):5},s.unstable_getCurrentPriorityLevel=function(){return y},s.unstable_getFirstCallbackNode=function(){return t(p)},s.unstable_next=function(j){switch(y){case 1:case 2:case 3:var te=3;break;default:te=y}var se=y;y=te;try{return j()}finally{y=se}},s.unstable_pauseExecution=function(){},s.unstable_requestPaint=function(){},s.unstable_runWithPriority=function(j,te){switch(j){case 1:case 2:case 3:case 4:case 5:break;default:j=3}var se=y;y=j;try{return te()}finally{y=se}},s.unstable_scheduleCallback=function(j,te,se){var O=s.unstable_now();switch(typeof se=="object"&&se!==null?(se=se.delay,se=typeof se=="number"&&0<se?O+se:O):se=O,j){case 1:var re=-1;break;case 2:re=250;break;case 5:re=1073741823;break;case 4:re=1e4;break;default:re=5e3}return re=se+re,j={id:S++,callback:te,priorityLevel:j,startTime:se,expirationTime:re,sortIndex:-1},se>O?(j.sortIndex=se,e(m,j),t(p)===null&&j===t(m)&&(w?(v(U),U=-1):w=!0,pe(T,se-O))):(j.sortIndex=re,e(p,j),b||M||(b=!0,ue(V))),j},s.unstable_shouldYield=B,s.unstable_wrapCallback=function(j){var te=y;return function(){var se=y;y=te;try{return j.apply(this,arguments)}finally{y=se}}}})(Ru)),Ru}var Hp;function Ux(){return Hp||(Hp=1,Cu.exports=Ix()),Cu.exports}/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xx=K.forwardRef(({color:s="currentColor",size:e=24,strokeWidth:t=2,absoluteStrokeWidth:r,className:a="",children:l,iconNode:d,...f},p)=>K.createElement("svg",{ref:p,...Wx,width:e,height:e,stroke:s,strokeWidth:r?Number(t)*24/Number(e):t,className:a0("lucide",a),...f},[...d.map(([m,S])=>K.createElement(m,S)),...Array.isArray(l)?l:[l]]));/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`)+`
`+v);const N=D+_+d,T=D+v+f,V=Fm(a,a.VERTEX_SHADER,N),z=Fm(a,a.FRAGMENT_SHADER,T);a.attachShader(w,V),a.attachShader(w,z),t.index0AttributeName!==void 0?a.bindAttribLocation(w,0,t.index0AttributeName):t.morphTargets===!0&&a.bindAttribLocation(w,0,"position"),a.linkProgram(w);function I(B){if(s.debug.checkShaderErrors){const oe=a.getProgramInfoLog(w).trim(),J=a.getShaderInfoLog(V).trim(),fe=a.getShaderInfoLog(z).trim();let me=!0,ue=!0;if(a.getProgramParameter(w,a.LINK_STATUS)===!1)if(me=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(a,w,V,z);else{const pe=zm(a,V,"vertex"),j=zm(a,z,"fragment");console.error("THREE.WebGLProgram: Shader Error "+a.getError()+" - VALIDATE_STATUS "+a.getProgramParameter(w,a.VALIDATE_STATUS)+`
...
`}),u.jsxs("div",{className:"flex items-center gap-3",children:[u.jsx("button",{onClick:C,className:"w-8 h-8 rounded-full hover:bg-white/10",children:a?u.jsx(a1,{size:16,className:"text-white"}):u.jsx(s1,{size:16,className:"text-white"})}),u.jsx("input",{type:"range",min:"0",max:"100",value:d,onChange:B,className:"flex-1 h-1.5 rounded-full volume-slider",style:{background:`linear-gradient(to right, rgb(var(--c1)) ${d}%, rgba(255,255,255,0.2) ${d}%)`}}),u.jsxs("span",{className:"text-xs text-white w-10 text-right",children:[d,"%"]})]})]})]})]})}const i0="/assets/sprite_9900x4800_70-pwo8PaYC.png",ud=9,cw=8,r0=70,uw=400,Pl=.96,dw=(s,e,t)=>{const r=s.scrollTop,a=e-r,l=performance.now(),d=f=>{const p=f-l,m=Math.min(p/t,1),S=m*(2-m);s.scrollTop=r+a*S,m<1&&requestAnimationFrame(d)};requestAnimationFrame(d)},Bo=1100,dd=600;function fw(){const s=K.useRef(null),e=K.useRef(null),t=K.useRef(null),r=K.useRef(null),a=K.useRef(null),l=K.useRef(!1),[d,f]=K.useState(!1),[p,m]=K.useState(!1),[S,x]=K.useState(!1),y=K.useRef(0),M=()=>{const _=e.current,v=t.current;if(!_||!v)return;const D=window.innerWidth,N=D/Bo,T=dd*N;v.style.height=`${T}px`,v.style.width=`${D}px`,_.style.width=`${Bo*ud*N}px`,_.style.height=`${dd*cw*N}px`},b=_=>{const v=e.current;if(!v)return;y.current=_;const D=window.innerWidth,N=D/Bo,T=_%ud,V=Math.floor(_/ud),z=D/2-(T*Bo+Bo/2)*N,I=-(V*dd*N);v.style.transform=`translate3d(${z}px, ${I}px, 0)`};K.useEffect(()=>{const _=()=>{x(window.innerWidth<768)};return _(),window.addEventListener("resize",_),()=>window.removeEventListener("resize",_)},[]),K.useEffect(()=>{const _=()=>{d&&(M(),b(y.current))};return window.addEventListener("resize",_),d&&(M(),b(0)),p||(document.body.style.overflow="hidden"),()=>{window.removeEventListener("resize",_),document.body.style.overflow="auto"}},[p,d]),K.useEffect(()=>{const _=new Image;_.src=i0,_.onload=()=>{f(!0)}},[]);const w=()=>{const _=s.current;!_||p||l.current||(window.requestAnimationFrame(()=>{const v=_.scrollTop,D=_.scrollHeight-_.clientHeight,N=Math.min(1,Math.max(0,v/D));if(a.current){const T=Math.max(0,1-N/.25);a.current.style.opacity=T.toString()}if(N<=Pl){const T=N/Pl,V=Math.floor(T*(r0-1));b(V),t.current&&(t.current.style.transform="scale(1)",t.current.style.opacity="1")}else{b(r0-1);const T=(N-Pl)/(1-Pl);if(t.current){const V=1-T*.5;t.current.style.transformOrigin="top left",t.current.style.transform=`scale(${V})`,t.current.style.opacity=(1-T).toString()}T>=.99&&m(!0)}l.current=!1}),l.current=!0)};return p?null:u.jsxs("div",{ref:s,onScroll:w,className:"scroll-video-overlay",style:{position:"fixed",inset:0,zIndex:99999,overflowY:"auto",overflowX:"hidden",background:"#000",scrollbarWidth:"none"},children:[u.jsx("style",{children:`
