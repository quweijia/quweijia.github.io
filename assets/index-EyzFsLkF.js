 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var zp;function Lx(){if(zp)return Da;zp=1;var s=nf(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),r=Object.prototype.hasOwnProperty,o=s.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,l={key:!0,ref:!0,__self:!0,__source:!0};function d(f,p,m){var S,x={},y=null,M=null;m!==void 0&&(y=""+m),p.key!==void 0&&(y=""+p.key),p.ref!==void 0&&(M=p.ref);for(S in p)r.call(p,S)&&!l.hasOwnProperty(S)&&(x[S]=p[S]);if(f&&f.defaultProps)for(S in p=f.defaultProps,p)x[S]===void 0&&(x[S]=p[S]);return{$$typeof:e,type:f,key:y,ref:M,props:x,_owner:o.current}}return Da.Fragment=t,Da.jsx=d,Da.jsxs=d,Da}var Bp;function kx(){return Bp||(Bp=1,Eu.exports=Lx()),Eu.exports}var u=kx(),rl={},Au={exports:{}},Cn={},Cu={exports:{}},Ru={};/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xx=K.forwardRef(({color:s="currentColor",size:e=24,strokeWidth:t=2,absoluteStrokeWidth:r,className:o="",children:l,iconNode:d,...f},p)=>K.createElement("svg",{ref:p,...Wx,width:e,height:e,stroke:s,strokeWidth:r?Number(t)*24/Number(e):t,className:o0("lucide",o),...f},[...d.map(([m,S])=>K.createElement(m,S)),...Array.isArray(l)?l:[l]]));/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`].filter(ja).join(`
`)),d=tf(d),d=Bm(d,t),d=jm(d,t),f=tf(f),f=Bm(f,t),f=jm(f,t),d=Hm(d),f=Hm(f),t.isRawShaderMaterial!==!0&&(N=`#version 300 es
