 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var zp;function Lx(){if(zp)return Da;zp=1;var s=nf(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),r=Object.prototype.hasOwnProperty,o=s.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,l={key:!0,ref:!0,__self:!0,__source:!0};function d(f,p,m){var S,x={},v=null,M=null;m!==void 0&&(v=""+m),p.key!==void 0&&(v=""+p.key),p.ref!==void 0&&(M=p.ref);for(S in p)r.call(p,S)&&!l.hasOwnProperty(S)&&(x[S]=p[S]);if(f&&f.defaultProps)for(S in p=f.defaultProps,p)x[S]===void 0&&(x[S]=p[S]);return{$$typeof:e,type:f,key:v,ref:M,props:x,_owner:o.current}}return Da.Fragment=t,Da.jsx=d,Da.jsxs=d,Da}var Bp;function kx(){return Bp||(Bp=1,Eu.exports=Lx()),Eu.exports}var u=kx(),rl={},Au={exports:{}},Cn={},Cu={exports:{}},Ru={};/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xx=Z.forwardRef(({color:s="currentColor",size:e=24,strokeWidth:t=2,absoluteStrokeWidth:r,className:o="",children:l,iconNode:d,...f},p)=>Z.createElement("svg",{ref:p,...Wx,width:e,height:e,stroke:s,strokeWidth:r?Number(t)*24/Number(e):t,className:o0("lucide",o),...f},[...d.map(([m,S])=>Z.createElement(m,S)),...Array.isArray(l)?l:[l]]));/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const rt=(s,e)=>{const t=Z.forwardRef(({className:r,...o},l)=>Z.createElement(Xx,{ref:l,iconNode:e,className:o0(`lucide-${Gx(Xp(s))}`,`lucide-${s}`,r),...o}));return t.displayName=Xp(s),t};/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`;class Re{constructor(L){var K;this.props=L||{},this.uniforms=(K=this.props.material)==null?void 0:K.uniforms,this.scene=null,this.camera=null,this.material=null,this.geometry=null,this.plane=null}init(){this.scene=new Ym,this.camera=new Bl,this.uniforms&&(this.material=new Rl(this.props.material),this.geometry=new Zr(2,2),this.plane=new Jn(this.geometry,this.material),this.scene.add(this.plane))}update(){fe.renderer.setRenderTarget(this.props.output||null),fe.renderer.render(this.scene,this.camera),fe.renderer.setRenderTarget(null)}}class Fe extends Re{constructor(L){super({material:{vertexShader:j,fragmentShader:O,uniforms:{boundarySpace:{value:L.cellScale},px:{value:L.cellScale},fboSize:{value:L.fboSize},velocity:{value:L.src.texture},dt:{value:L.dt},isBFECC:{value:!0}}},output:L.dst}),this.uniforms=this.props.material.uniforms,this.init()}init(){super.init(),this.createBoundary()}createBoundary(){const L=new Xi,K=new Float32Array([-1,-1,0,-1,1,0,-1,1,0,1,1,0,1,1,0,1,-1,0,1,-1,0,-1,-1,0]);L.setAttribute("position",new hi(K,3));const $=new Rl({vertexShader:te,fragmentShader:O,uniforms:this.uniforms});this.line=new bb(L,$),this.scene.add(this.line)}update({dt:L,isBounce:K,BFECC:$}){this.uniforms.dt.value=L,this.line.visible=K,this.uniforms.isBFECC.value=$,super.update()}}class Ke extends Re{constructor(L){super({output:L.dst}),this.init(L)}init(L){super.init();const K=new Zr(1,1),$=new Rl({vertexShader:se,fragmentShader:ne,blending:pd,depthWrite:!1,uniforms:{px:{value:L.cellScale},force:{value:new ct(0,0)},center:{value:new ct(0,0)},scale:{value:new ct(L.cursor_size,L.cursor_size)}}});this.mouse=new Jn(K,$),this.scene.add(this.mouse)}update(L){const K=ue.diff.x/2*L.mouse_force,$=ue.diff.y/2*L.mouse_force,Te=L.cursor_size*L.cellScale.x,Me=L.cursor_size*L.cellScale.y,Ne=Math.min(Math.max(ue.coords.x,-1+Te+L.cellScale.x*2),1-Te-L.cellScale.x*2),ot=Math.min(Math.max(ue.coords.y,-1+Me+L.cellScale.y*2),1-Me-L.cellScale.y*2),_e=this.mouse.material.uniforms;_e.force.value.set(K,$),_e.center.value.set(Ne,ot),_e.scale.value.set(L.cursor_size,L.cursor_size),super.update()}}class At extends Re{constructor(L){super({material:{vertexShader:j,fragmentShader:Se,uniforms:{boundarySpace:{value:L.boundarySpace},velocity:{value:L.src.texture},velocity_new:{value:L.dst_.texture},v:{value:L.viscous},px:{value:L.cellScale},dt:{value:L.dt}}},output:L.dst,output0:L.dst_,output1:L.dst}),this.init()}update({viscous:L,iterations:K,dt:$}){let Te,Me;this.uniforms.v.value=L;for(let Ne=0;Ne<K;Ne++)Ne%2===0?(Te=this.props.output0,Me=this.props.output1):(Te=this.props.output1,Me=this.props.output0),this.uniforms.velocity_new.value=Te.texture,this.props.output=Me,this.uniforms.dt.value=$,super.update();return Me}}class pt extends Re{constructor(L){super({material:{vertexShader:j,fragmentShader:Le,uniforms:{boundarySpace:{value:L.boundarySpace},velocity:{value:L.src.texture},px:{value:L.cellScale},dt:{value:L.dt}}},output:L.dst}),this.init()}update({vel:L}){this.uniforms.velocity.value=L.texture,super.update()}}class Nt extends Re{constructor(L){super({material:{vertexShader:j,fragmentShader:ge,uniforms:{boundarySpace:{value:L.boundarySpace},pressure:{value:L.dst_.texture},divergence:{value:L.src.texture},px:{value:L.cellScale}}},output:L.dst,output0:L.dst_,output1:L.dst}),this.init()}update({iterations:L}){let K,$;for(let Te=0;Te<L;Te++)Te%2===0?(K=this.props.output0,$=this.props.output1):(K=this.props.output1,$=this.props.output0),this.uniforms.pressure.value=K.texture,this.props.output=$,super.update();return $}}class Y extends Re{constructor(L){super({material:{vertexShader:j,fragmentShader:we,uniforms:{boundarySpace:{value:L.boundarySpace},pressure:{value:L.src_p.texture},velocity:{value:L.src_v.texture},px:{value:L.cellScale},dt:{value:L.dt}}},output:L.dst}),this.init()}update({vel:L,pressure:K}){this.uniforms.velocity.value=L.texture,this.uniforms.pressure.value=K.texture,super.update()}}class rn{constructor(L){this.options={iterations_poisson:32,iterations_viscous:32,mouse_force:20,resolution:.5,cursor_size:100,viscous:30,isBounce:!1,dt:.014,isViscous:!1,BFECC:!0,...L},this.fbos={vel_0:null,vel_1:null,vel_viscous0:null,vel_viscous1:null,div:null,pressure_0:null,pressure_1:null},this.fboSize=new ct,this.cellScale=new ct,this.boundarySpace=new ct,this.init()}init(){this.calcSize(),this.createAllFBO(),this.createShaderPass()}getFloatType(){return/(iPad|iPhone|iPod)/i.test(navigator.userAgent)?Zs:_i}createAllFBO(){const K={type:this.getFloatType(),depthBuffer:!1,stencilBuffer:!1,minFilter:Pn,magFilter:Pn,wrapS:fi,wrapT:fi};for(let $ in this.fbos)this.fbos[$]=new wr(this.fboSize.x,this.fboSize.y,K)}createShaderPass(){this.advection=new Fe({cellScale:this.cellScale,fboSize:this.fboSize,dt:this.options.dt,src:this.fbos.vel_0,dst:this.fbos.vel_1}),this.externalForce=new Ke({cellScale:this.cellScale,cursor_size:this.options.cursor_size,dst:this.fbos.vel_1}),this.viscous=new At({cellScale:this.cellScale,boundarySpace:this.boundarySpace,viscous:this.options.viscous,src:this.fbos.vel_1,dst:this.fbos.vel_viscous1,dst_:this.fbos.vel_viscous0,dt:this.options.dt}),this.divergence=new pt({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src:this.fbos.vel_viscous0,dst:this.fbos.div,dt:this.options.dt}),this.poisson=new Nt({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src:this.fbos.div,dst:this.fbos.pressure_1,dst_:this.fbos.pressure_0}),this.pressure=new Y({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src_p:this.fbos.pressure_0,src_v:this.fbos.vel_viscous0,dst:this.fbos.vel_0,dt:this.options.dt})}calcSize(){const L=Math.max(1,Math.round(this.options.resolution*fe.width)),K=Math.max(1,Math.round(this.options.resolution*fe.height)),$=1/L,Te=1/K;this.cellScale.set($,Te),this.fboSize.set(L,K)}resize(){this.calcSize();for(let L in this.fbos)this.fbos[L].setSize(this.fboSize.x,this.fboSize.y)}update(){this.options.isBounce?this.boundarySpace.set(0,0):this.boundarySpace.copy(this.cellScale),this.advection.update({dt:this.options.dt,isBounce:this.options.isBounce,BFECC:this.options.BFECC}),this.externalForce.update({cursor_size:this.options.cursor_size,mouse_force:this.options.mouse_force,cellScale:this.cellScale});let L=this.fbos.vel_1;this.options.isViscous&&(L=this.viscous.update({viscous:this.options.viscous,iterations:this.options.iterations_viscous,dt:this.options.dt})),this.divergence.update({vel:L});const K=this.poisson.update({iterations:this.options.iterations_poisson});this.pressure.update({vel:L,pressure:K})}}class ht{constructor(){this.init()}init(){this.simulation=new rn,this.scene=new Ym,this.camera=new Bl,this.output=new Jn(new Zr(2,2),new Rl({vertexShader:j,fragmentShader:re,transparent:!0,depthWrite:!1,uniforms:{velocity:{value:this.simulation.fbos.vel_0.texture},boundarySpace:{value:new ct},palette:{value:B},bgColor:{value:ae}}})),this.scene.add(this.output)}addScene(L){this.scene.add(L)}resize(){this.simulation.resize()}render(){fe.renderer.setRenderTarget(null),fe.renderer.render(this.scene,this.camera)}update(){this.simulation.update(),this.render()}}class dt{constructor(L){this.props=L,fe.init(L.$wrapper),ue.init(L.$wrapper),ue.autoIntensity=L.autoIntensity,ue.takeoverDuration=L.takeoverDuration,this.lastUserInteraction=performance.now(),ue.onInteract=()=>{this.lastUserInteraction=performance.now(),this.autoDriver&&this.autoDriver.forceStop()},this.autoDriver=new pe(ue,this,{enabled:L.autoDemo,speed:L.autoSpeed,resumeDelay:L.autoResumeDelay,rampDuration:L.autoRampDuration}),this.init(),this._loop=this.loop.bind(this),this._resize=this.resize.bind(this),window.addEventListener("resize",this._resize),this._onVisibility=()=>{document.hidden?this.pause():U.current&&this.start()},document.addEventListener("visibilitychange",this._onVisibility),this.running=!1}init(){this.props.$wrapper.prepend(fe.renderer.domElement),this.output=new ht}resize(){fe.resize(),this.output.resize()}render(){this.autoDriver&&this.autoDriver.update(),ue.update(),fe.update(),this.output.update()}loop(){this.running&&(this.render(),z.current=requestAnimationFrame(this._loop))}start(){this.running||(this.running=!0,this._loop())}pause(){this.running=!1,z.current&&(cancelAnimationFrame(z.current),z.current=null)}dispose(){try{if(window.removeEventListener("resize",this._resize),document.removeEventListener("visibilitychange",this._onVisibility),ue.dispose(),fe.renderer){const L=fe.renderer.domElement;L&&L.parentNode&&L.parentNode.removeChild(L),fe.renderer.dispose(),fe.renderer.forceContextLoss()}}catch{}}}const Ye=P.current;Ye.style.overflow="hidden";const Mt=new dt({$wrapper:Ye,autoDemo:M,autoSpeed:b,autoIntensity:w,takeoverDuration:_,autoResumeDelay:y,autoRampDuration:D});T.current=Mt,(()=>{var K;if(!T.current)return;const X=(K=T.current.output)==null?void 0:K.simulation;if(!X)return;const L=X.options.resolution;Object.assign(X.options,{mouse_force:s,cursor_size:e,isViscous:t,viscous:r,iterations_viscous:o,iterations_poisson:l,dt:d,BFECC:f,resolution:p,isBounce:m}),p!==L&&X.resize()})(),Mt.start();const k=new IntersectionObserver(X=>{const L=X[0],K=L.isIntersecting&&L.intersectionRatio>0;U.current=K,T.current&&(K&&!document.hidden?T.current.start():T.current.pause())},{threshold:[0,.01,.1]});k.observe(Ye),I.current=k;const A=new ResizeObserver(()=>{T.current&&(N.current&&cancelAnimationFrame(N.current),N.current=requestAnimationFrame(()=>{T.current&&T.current.resize()}))});return A.observe(Ye),W.current=A,()=>{if(z.current&&cancelAnimationFrame(z.current),W.current)try{W.current.disconnect()}catch{}if(I.current)try{I.current.disconnect()}catch{}T.current&&T.current.dispose(),T.current=null}},[f,e,d,m,t,l,o,s,p,r,S,M,b,w,_,y,D]),Z.useEffect(()=>{var J;const C=T.current;if(!C)return;const B=(J=C.output)==null?void 0:J.simulation;if(!B)return;const ae=B.options.resolution;Object.assign(B.options,{mouse_force:s,cursor_size:e,isViscous:t,viscous:r,iterations_viscous:o,iterations_poisson:l,dt:d,BFECC:f,resolution:p,isBounce:m}),C.autoDriver&&(C.autoDriver.enabled=M,C.autoDriver.speed=b,C.autoDriver.resumeDelay=y,C.autoDriver.rampDurationMs=D*1e3,C.autoDriver.mouse&&(C.autoDriver.mouse.autoIntensity=w,C.autoDriver.mouse.takeoverDuration=_)),p!==ae&&B.resize()},[s,e,t,r,o,l,d,f,p,m,M,b,w,_,y,D]),u.jsx("div",{ref:P,className:`absolute inset-0 w-full h-full overflow-hidden pointer-events-none touch-none ${v||""}`,style:{zIndex:0,...x}})}function Eb(){const s=Z.useRef(null),e=Z.useRef({x:-999,y:-999});return Z.useEffect(()=>{const t=s.current,r=t.getContext("2d");let o=0,l=0,d=0,f=[];const p=()=>{o=t.offsetWidth,l=t.offsetHeight,t.width=o*devicePixelRatio,t.height=l*devicePixelRatio,r.scale(devicePixelRatio,devicePixelRatio);const b=Math.floor(o*l/9e3);f=Array.from({length:Math.min(b,110)},()=>({x:Math.random()*o,y:Math.random()*l,vx:(Math.random()-.5)*.45,vy:(Math.random()-.5)*.45,r:Math.random()*1.6+.4,opacity:Math.random()*.6+.2}))},m=140,S=()=>{r.clearRect(0,0,o,l),f.forEach(b=>{b.x+=b.vx,b.y+=b.vy,(b.x<0||b.x>o)&&(b.vx*=-1),(b.y<0||b.y>l)&&(b.vy*=-1);const w=b.x-e.current.x,_=b.y-e.current.y,y=Math.sqrt(w*w+_*_);if(y<100){const P=(100-y)/100;b.x+=w*P*.025,b.y+=_*P*.025}const D=y<80;r.beginPath(),r.arc(b.x,b.y,D?b.r*2:b.r,0,Math.PI*2),r.fillStyle=D?`rgba(${getComputedStyle(document.documentElement).getPropertyValue("--c1").trim()||"0,240,200"},${b.opacity*1.8})`:`rgba(${getComputedStyle(document.documentElement).getPropertyValue("--c1").trim()||"0,240,200"},${b.opacity*.6})`,r.fill()});for(let b=0;b<f.length;b++)for(let w=b+1;w<f.length;w++){const _=f[b].x-f[w].x,y=f[b].y-f[w].y,D=Math.sqrt(_*_+y*y);if(D<m){const P=(1-D/m)*.25;r.beginPath(),r.moveTo(f[b].x,f[b].y),r.lineTo(f[w].x,f[w].y),r.strokeStyle=`rgba(${getComputedStyle(document.documentElement).getPropertyValue("--c1").trim()||"0,240,200"},${P})`,r.lineWidth=.7,r.stroke()}}f.forEach(b=>{const w=b.x-e.current.x,_=b.y-e.current.y,y=Math.sqrt(w*w+_*_);if(y<130){const D=(1-y/130)*.5;r.beginPath(),r.moveTo(b.x,b.y),r.lineTo(e.current.x,e.current.y),r.strokeStyle=`rgba(${getComputedStyle(document.documentElement).getPropertyValue("--c1").trim()||"0,240,200"},${D})`,r.lineWidth=.6,r.stroke()}}),d=requestAnimationFrame(S)};p(),S();const x=b=>{const w=t.getBoundingClientRect();e.current={x:b.clientX-w.left,y:b.clientY-w.top}},v=()=>{e.current={x:-999,y:-999}};window.addEventListener("mousemove",x),t.addEventListener("mouseleave",v);const M=new ResizeObserver(p);return M.observe(t),()=>{cancelAnimationFrame(d),window.removeEventListener("mousemove",x),t.removeEventListener("mouseleave",v),M.disconnect()}},[]),u.jsx("canvas",{ref:s,className:"absolute inset-0 w-full h-full pointer-events-none z-5"})}function Tb({words:s}){const[e,t]=Z.useState(0),[r,o]=Z.useState(""),[l,d]=Z.useState(!1);return Z.useEffect(()=>{const f=s[e%s.length];if(!l&&r===f){const S=setTimeout(()=>d(!0),2e3);return()=>clearTimeout(S)}if(l&&r===""){d(!1),t(S=>S+1);return}const m=setTimeout(()=>{o(l?f.slice(0,r.length-1):f.slice(0,r.length+1))},l?50:90);return()=>clearTimeout(m)},[r,l,e,s]),u.jsxs("span",{style:{color:"rgb(var(--c1))"},children:[r,u.jsx("span",{className:"animate-pulse",style:{color:"rgb(var(--c1))",marginLeft:2},children:"|"})]})}function Ab({target:s,suffix:e=""}){const[t,r]=Z.useState(0),o=Z.useRef(null);return Z.useEffect(()=>{const l=new IntersectionObserver(([d])=>{if(d.isIntersecting){let f=0;const p=s/60,m=setInterval(()=>{f=Math.min(f+p,s),r(Math.floor(f)),f>=s&&clearInterval(m)},20);l.disconnect()}},{threshold:.5});return o.current&&l.observe(o.current),()=>l.disconnect()},[s]),u.jsxs("span",{ref:o,children:[t,e]})}function Cb(){const s=Z.useRef(null),[e,t]=Z.useState(0),[r,o]=Z.useState(!1),[l,d]=Z.useState(!1),[f,p]=Z.useState({}),[m,S]=Z.useState(!1),x=P=>{const T=P.replace("#",""),W=parseInt(T.substring(0,2),16),z=parseInt(T.substring(2,4),16),I=parseInt(T.substring(4,6),16);return`${W}, ${z}, ${I}`};Z.useEffect(()=>{const T=()=>S(window.innerWidth<=640);return T(),window.addEventListener("resize",T),()=>window.removeEventListener("resize",T)},[]);const v=[{img:"/assets/images/banner1.png",label:"Design Systems",accent:"#7c6ff7",accentBg:"rgba(124,111,247,0.12)",accentBorder:"rgba(124,111,247,0.28)",Icon:u0},{img:"/assets/images/banner2.png",label:"团队分享会-设计赋能",accent:"#FE952C",accentBg:"rgba(254, 149, 44, 0.12)",accentBorder:"rgba(254, 149, 44, 0.30)",Icon:Gv},{img:"/assets/images/banner3.png",label:"设计复盘",accent:"#456CFF",accentBg:"rgba(69, 108, 255, 0.12)",accentBorder:"rgba(69, 108, 255, 0.30)",Icon:Mv},{img:"/assets/images/banner4.png",label:"设计扩展",accent:"#f472b6",accentBg:"rgba(244,114,182,0.12)",accentBorder:"rgba(244,114,182,0.28)",Icon:h0},{img:"/assets/images/banner5.png",label:"设计获奖",accent:"#FFEB12",accentBg:"rgba(255,235,18,0.12)",accentBorder:"rgba(255,235,18,0.28)",Icon:t1}],M=(P,T=!1)=>{if(P!==e){if(T){t(P),d(!1);return}l||(d(!0),setTimeout(()=>{t(P),d(!1)},350))}};Z.useEffect(()=>{if(r)return;const P=setInterval(()=>{d(!0),setTimeout(()=>{t(T=>(T+1)%v.length),d(!1)},320)},3800);return()=>clearInterval(P)},[r,v.length]);const b=P=>{const T=s.current.getBoundingClientRect(),W=P.clientX-T.left,z=P.clientY-T.top,I=W/T.width-.5,U=z/T.height-.5;s.current.style.transform=`perspective(900px) rotateY(${I*12}deg) rotateX(${-U*10}deg) scale3d(1.02,1.02,1.02)`,s.current.style.setProperty("--mouse-x",`${W}px`),s.current.style.setProperty("--mouse-y",`${z}px`);const N=Math.sqrt(I*I+U*U),C=Math.min(1,Math.max(0,N*2));s.current.style.setProperty("--glow-opacity",`${.4+C*.6}`);const B=200+N*550;s.current.style.setProperty("--border-glow-radius",`${B}px`)},w=()=>{s.current.style.transform="perspective(900px) rotateY(0) rotateX(0) scale3d(1,1,1)",o(!1),s.current.style.setProperty("--mouse-x","-999px"),s.current.style.setProperty("--mouse-y","-999px"),s.current.style.setProperty("--glow-opacity","0"),s.current.style.setProperty("--border-glow-radius","260px")},_=v[e],y=_.Icon,D=m?"16/9":"16/10";return u.jsxs("div",{ref:s,onMouseMove:b,onMouseEnter:()=>o(!0),onMouseLeave:w,className:"relative rounded-2xl cursor-pointer w-full !min-w-0",style:{transition:"transform 0.15s ease-out, background 0.4s ease",transformStyle:"preserve-3d","--accent-rgb":x(_.accent),background:`
...
`}),u.jsxs("div",{className:"flex items-center gap-3",children:[u.jsx("button",{onClick:C,className:"w-8 h-8 rounded-full hover:bg-white/10",children:o?u.jsx(o1,{size:16,className:"text-white"}):u.jsx(s1,{size:16,className:"text-white"})}),u.jsx("input",{type:"range",min:"0",max:"100",value:d,onChange:B,className:"flex-1 h-1.5 rounded-full volume-slider",style:{background:`linear-gradient(to right, rgb(var(--c1)) ${d}%, rgba(255,255,255,0.2) ${d}%)`}}),u.jsxs("span",{className:"text-xs text-white w-10 text-right",children:[d,"%"]})]})]})]})]})}const i0="/assets/sprite_9900x4800_70-pwo8PaYC.png",ud=9,cw=8,r0=70,uw=400,Pl=.96,dw=(s,e,t)=>{const r=s.scrollTop,o=e-r,l=performance.now(),d=f=>{const p=f-l,m=Math.min(p/t,1),S=m*(2-m);s.scrollTop=r+o*S,m<1&&requestAnimationFrame(d)};requestAnimationFrame(d)},za=1100,dd=600;function fw(){const s=Z.useRef(null),e=Z.useRef(null),t=Z.useRef(null),r=Z.useRef(null),o=Z.useRef(null),l=Z.useRef(!1),[d,f]=Z.useState(!1),[p,m]=Z.useState(!1),[S,x]=Z.useState(!1),v=Z.useRef(0),M=()=>{const _=e.current,y=t.current;if(!_||!y)return;const D=window.innerWidth,P=D/za,T=dd*P;y.style.height=`${T}px`,y.style.width=`${D}px`,_.style.width=`${za*ud*P}px`,_.style.height=`${dd*cw*P}px`},b=_=>{const y=e.current;if(!y)return;v.current=_;const D=window.innerWidth,P=D/za,T=_%ud,W=Math.floor(_/ud),z=D/2-(T*za+za/2)*P,I=-(W*dd*P);y.style.transform=`translate3d(${z}px, ${I}px, 0)`};Z.useEffect(()=>{const _=()=>{x(window.innerWidth<768)};return _(),window.addEventListener("resize",_),()=>window.removeEventListener("resize",_)},[]),Z.useEffect(()=>{const _=()=>{d&&(M(),b(v.current))};return window.addEventListener("resize",_),d&&(M(),b(0)),p||(document.body.style.overflow="hidden"),()=>{window.removeEventListener("resize",_),document.body.style.overflow="auto"}},[p,d]),Z.useEffect(()=>{const _=new Image;_.src=i0,_.onload=()=>{f(!0)}},[]);const w=()=>{const _=s.current;!_||p||l.current||(window.requestAnimationFrame(()=>{const y=_.scrollTop,D=_.scrollHeight-_.clientHeight,P=Math.min(1,Math.max(0,y/D));if(o.current){const T=Math.max(0,1-P/.25);o.current.style.opacity=T.toString()}if(P<=Pl){const T=P/Pl,W=Math.floor(T*(r0-1));b(W),t.current&&(t.current.style.transform="scale(1)",t.current.style.opacity="1")}else{b(r0-1);const T=(P-Pl)/(1-Pl);if(t.current){const W=1-T*.5;t.current.style.transformOrigin="top left",t.current.style.transform=`scale(${W})`,t.current.style.opacity=(1-T).toString()}T>=.99&&m(!0)}l.current=!1}),l.current=!0)};return p?null:u.jsxs("div",{ref:s,onScroll:w,className:"scroll-video-overlay",style:{position:"fixed",inset:0,zIndex:99999,overflowY:"auto",overflowX:"hidden",background:"#000",scrollbarWidth:"none"},children:[u.jsx("style",{children:`
      ...
      `}),u.jsx("div",{style:{height:`${uw}vh`,position:"relative"},children:u.jsxs("div",{style:{position:"sticky",top:0,height:"100vh",width:"100%",overflow:"hidden",background:"#000"},children:[u.jsx("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",transform:S?"translateY(-60px)":"translateY(0)",zIndex:2},children:u.jsx("div",{ref:t,style:{position:"relative",overflow:"hidden",willChange:"transform, opacity",transform:S?"translateY(-60px)":"translateY(0)"},children:u.jsx("img",{ref:e,src:i0,alt:"intro-sprite",style:{position:"absolute",top:0,left:0,maxWidth:"none",display:"block",willChange:"transform",pointerEvents:"none",opacity:d?1:0}})})}),u.jsx("div",{ref:o,style:{position:"absolute",inset:0,transition:"opacity 0.2s ease",zIndex:3,pointerEvents:"none"},children:u.jsx(q0,{colors:["#00f0c8","#7c6ff7","#ff9ffc"],autoDemo:!0,autoSpeed:.5,autoIntensity:2.2})}),!d&&u.jsxs("div",{style:{position:"absolute",inset:0,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:"#000",zIndex:100},children:[u.jsx("div",{className:"loading-text",style:{color:"white",fontSize:"12px",fontWeight:300,textTransform:"uppercase"},children:"Loading"}),u.jsx("div",{style:{width:"70px",height:"1.5px",background:"rgba(255,255,255,0.15)",marginTop:"6px",position:"relative",overflow:"hidden"},children:u.jsx("div",{className:"animate-shimmer-run",style:{position:"absolute",inset:0,background:"linear-gradient(90deg, transparent, rgba(255,255,255,0.8), transparent)"}})})]}),u.jsx("div",{ref:r,style:{position:"absolute",bottom:"8vh",width:"100%",display:"flex",justifyContent:"center",zIndex:10},children:u.jsxs("button",{onClick:_=>{_.preventDefault();const y=s.current;if(!y)return;const D=y.scrollHeight-y.clientHeight;dw(y,D,2800)},className:`
